...
export const AUTHORS: Author[] = [
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Deepesh+Patel&background=0B1120&color=FF1F1F&size=256&font-size=0.4&bold=true&rounded=true',
    experience: 5,
  ...
  },
  {
    ...
    avatar:  'https://ui-avatars.com/api/?name=Kamlesh+Gupta&background=0054D2&color=fff&size=256&font-size=0.4&bold=true&rounded=true',
    experience: 4,
  ...
  },
  {
    ...
    avatar:  'https://ui-avatars.com/api/?name=Deepanshu+Kumar&background=1a1a2e&color=fff&size=256&font-size=0.4&bold=true&rounded=true',
    experience: 3,
