...
const PLANS = [
  {
    ...
    features: [
      ...
      'Basic SEO Setup',
      '5 Graphic Designs/mo',
      'Monthly Performance Report',
      'Email Support',
    ],
    missing: ['Ads Management', 'AI Automation', '24/7 Support'],
    isPopular: false,
  },
  {
    name: 'Growth',
    ...
    features: [
      ...
      '10 Graphic Designs + 2 Reels/mo',
      'Bi-Weekly Strategy Calls',
    ],
    missing: ['AI Chatbot Integration', 'Custom CRM Setup'],
    isPopular: true,
  },
  {
    name: 'Business',
    ...
    features: [
      ...
      'Video Editing (4 Reels/mo)',
      'Custom CRM & Lead Scoring',
  ...
  {
    name: 'Enterprise',
    tagline: 'Custom solution for large orgs',
    price: 'Custom',
    originalPrice: null,
    discount: null,
    features: [
