    ...
    <div className="w-full min-h-screen bg-brand-bg">
      ...
      <section className="pt-28 pb-12 md:pt-32 md:pb-16 px-4 md:px-6">
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-brand-dark mb-6 tracking-tight">
            Our Blog
          </h1>
          <p className="text-lg md:text-xl text-brand-dark/60 max-w-2xl mx-auto mb-10 md:mb-12 px-4">
            Deep dives into digital strategy, automation, and design to help you stay ahead of
            the curve.
          </p>
          ...
          <div className="max-w-xl mx-auto relative mb-10 md:mb-16">
            <input
              ...
              className="w-full px-5 py-3 md:px-6 md:py-4 rounded-full bg-white border-2 border-transparent focus:border-brand-dark focus:outline-none shadow-lg text-base md:text-lg pl-12 md:pl-14 transition-all"
              value={searchTerm}
      ...
      <section className="px-4 md:px-6 pb-20">
        <div className="max-w-[1400px] mx-auto">
          {filteredResources.length === 0 ? (
            <p className="text-center text-gray-400 py-20">No articles match your search.</p>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {filteredResources.map((resource) => (
                <div
                  key={resource.id}
                  className="group bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2"
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-xs font-bold text-brand-lime uppercase tracking-wide">
                        {resource.category}
                      </span>
                    ...
                    <Link
                      href="#"
                      className="inline-flex items-center gap-2 text-sm font-bold text-brand-dark group-hover:gap-3 transition-all"
                    >
